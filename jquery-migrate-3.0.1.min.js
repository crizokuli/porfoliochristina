  ...
  (function (e) {
    ...
    e.data = function (t, n, a) {
      ...
      return n && "string" == typeof n && n !== e.camelCase(n) && (o = e.hasData(t) && g.call(this, t)) && n in o
        ? (r("jQuery.data() always sets/gets camelCased names: " + n), arguments.length > 2 && (o[n] = a), o[n])
    ...
    e.fn.offset = function () {
      ...
      return a && a.nodeType
        ? ((n = (a.ownerDocument || t.document).documentElement), e.contains(n, a) ? x.apply(this, arguments) : (r("jQuery.fn.offset() requires an element connected to a document"), o))
